...
{
    /// <summary>
    /// Describes specific data for each project created in Editor...
    /// Name, Path, and Date.
    /// </summary>
    [DataContract]
    ...
    /// <summary>
    /// List of all the pojects that have been created with Editor, as ProjectData.
    /// </summary>
    [DataContract]
    ...
    /// <summary>
    /// View Model that handles the opening of a Project, and inherits from
    /// Editor.ViewModelBase
    /// </summary>
    class OpenProject
    {
        // STATE
        private static readonly string applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\Editor\";
        ...
        /// <summary>
        /// Open a specified project in Editor.
        /// </summary>
            ...
            if (File.Exists(projectDataPath))
            {
                ...
                foreach (var project in newProjects)
                {
                    if (File.Exists(project.FullPath))
                    {
                        ...
                        project.ScreenShot = File.ReadAllBytes($@"{project.ProjectPath}\.\ScreenShot.png");
                        projects.Add(project);
                    }
                }
            }
